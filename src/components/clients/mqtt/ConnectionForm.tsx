// src/components/clients/mqtt/ConnectionForm.tsx
...
import { SavedConnection } from "@/types/mqtt/connection"; // Assuming MqttConnectionOptions is also in connection.ts
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
import { generateClientId } from "@/utils/mqtt/idGenerator";
...
const ConnectionForm: React.FC<ConnectionFormProps> = ({
  ...
  useEffect(() => {
    if (connection) {
      ...
      setHost(connection.options.host || "broker.emqx.io");
      setPort(connection.options.port || 1883);
      ...
      setUseSsl(initialProtocol.endsWith("s") || false); // Add || false to ensure it's boolean
  ...
  const handleProtocolChange = (value: string) => {
    ...
    setUseSsl(newProtocol.endsWith("s")); // Update useSsl based on protocol
  };
...
<div className="bg-gradient-to-br from-gray-900 to-gray-950 p-6 rounded-2xl shadow-xl border border-gray-800 backdrop-blur-lg bg-opacity-80 transition-all duration-300 hover:shadow-2xl">
  <div className="flex justify-between items-center mb-4 border-b border-gray-800 pb-3">
    ...
    <Button
      ...
      className="text-gray-400 hover:text-white transition-all duration-300 hover:bg-gray-800 rounded-full p-2"
      variant="ghost"
    >
      {isExpanded ? (
        <>
          <ChevronUp className="mr-1 h-5 w-5 transition-transform duration-300" /> Collapse
        </>
      ) : (
        <>
          <ChevronDown className="mr-1 h-5 w-5 transition-transform duration-300" /> Expand
        </>
      )}
    </Button>
  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
            ...
            <div className="col-span-2 group">
              <div className="flex items-center mb-2">
                <Label htmlFor="connectionName" className="text-gray-200 font-medium">
                  Connection Name
                </Label>
                <Tooltip>
            ...
            <div className="col-span-2 group">
              <div className="flex items-center mb-2">
                <Label htmlFor="clientId" className="text-gray-200 font-medium">
                  Client ID
                </Label>
                <Tooltip>
                  <TooltipTrigger asChild>
              ...
              <div className="relative">
                ...
                <Button
                  ...
                  onClick={() =>
                    setClientId(`mqttx_${Math.random().toString(16).substr(2, 8)}`)
                  }
                >
            ...
            {/* Protocol and SSL */}
            <div className="group">
              <Label htmlFor="protocol" className="text-gray-200 font-medium">
                Protocol
              </Label>
                ...
                <SelectContent className="bg-gray-900 border-gray-800 text-white rounded-lg">
                  ...
                  >
                    <div className="flex items-center">
                      <Globe className="mr-2 h-5 w-5 text-indigo-400" /> WebSocket
                    </div>
                  </SelectItem>
                  <SelectItem
                    value="wss"
                  ...
                  >
                    <div className="flex items-center">
                      <Lock className="mr-2 h-5 w-5 text-indigo-400" /> WebSocket Secure
                    </div>
                  </SelectItem>
                </SelectContent>
              </Select>
            ...
            <div className="group">
              <Label htmlFor="keepalive" className="text-gray-200 font-medium">
                Keep Alive (seconds)
              </Label>
              <div className="relative mt-2">
            ...
            <div className="group">
              <Label htmlFor="connectTimeout" className="text-gray-200 font-medium">
                Connect Timeout (ms)
              </Label>
              <div className="relative mt-2">
            ...
            <div className="group">
              <Label htmlFor="reconnectPeriod" className="text-gray-200 font-medium">
                Reconnect Period (ms)
              </Label>
              <div className="relative mt-2">
                ...
                <Input
                  ...
                  onChange={(e) => setReconnectPeriod(Number(e.target.value))}
                  className="pl-10 bg-gray-800/50 border-gray-700 hover:border-indigo-500 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/50 text-white transition-all duration-300 rounded-lg"
                  min={0}
                />
              </div>
              ...
              <Accordion type="single" collapsible className="w-full">
                ...
                >
                  <AccordionTrigger className="px-4 py-3 hover:no-underline text-white text-lg font-semibold flex items-center bg-gray-800/50">
                    <Zap size={20} className="mr-2 text-yellow-400 animate-pulse" />
                  ...
                  <AccordionContent className="p-4 bg-gray-900/50">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                      <div className="group">
                        <Label htmlFor="protocolVersion" className="text-gray-200 font-medium">
                          Protocol Version
                        </Label>
                        <Select
                          value={String(protocolVersion)}
                          onValueChange={(val) => setProtocolVersion(Number(val) as 4 | 5)}
                        >
                      ...
                      {protocolVersion === 5 && (
                        <>
                          <div className="group">
                            <Label htmlFor="sessionExpiryInterval" className="text-gray-200 font-medium">
                          ...
                          <div className="group">
                            <Label htmlFor="receiveMaximum" className="text-gray-200 font-medium">
                              Receive Maximum
                            </Label>
                            <Input
                              id="receiveMaximum"
                          ...
                          <div className="group">
                            <Label htmlFor="maximumPacketSize" className="text-gray-200 font-medium">
                              Maximum Packet Size
                            </Label>
                            <Input
                          ...
                          <div className="group">
                            <Label htmlFor="topicAliasMaximum" className="text-gray-200 font-medium">
                              Topic Alias Maximum
                            </Label>
                            <Input
                          ...
                          <div className="flex items-center group">
                            <Switch
                              ...
                              onCheckedChange={(checked) => setRequestResponseInformation(checked)}
                              className="data-[state=checked]:bg-indigo-500 data-[state=unchecked]:bg-gray-700 transition-colors duration-300"
                            />
                            <Label
                          ...
                          <div className="flex items-center group">
                            <Switch
                              ...
                              onCheckedChange={(checked) => setRequestProblemInformation(checked)}
                              className="data-[state=checked]:bg-indigo-500 data-[state=unchecked]:bg-gray-700 transition-colors duration-300"
                            />
                            <Label
                          ...
                          <div className="col-span-2 group">
                            <Label htmlFor="userProperties" className="text-gray-200 font-medium">
            ...
            <div className="col-span-2 mt-6">
              <Accordion type="single" collapsible className="w-full">
                ...
                >
                  <AccordionTrigger className="px-4 py-3 hover:no-underline text-white text-lg font-semibold flex items-center bg-gray-800/50">
                    <MessageSquareText size={20} className="mr-2 text-green-400 animate-pulse" />
                  ...
                  <AccordionContent className="p-4 bg-gray-900/50">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                      <div className="group">
                        <Label htmlFor="willTopic" className="text-gray-200 font-medium">
                          Will Topic
                        </Label>
                        <Input
                          id="willTopic"
                      ...
                      <div className="group">
                        <Label htmlFor="willPayload" className="text-gray-200 font-medium">
                          Will Payload
                        </Label>
                        <Input
                          id="willPayload"
                      ...
                      <div className="group">
                        <Label htmlFor="willQos" className="text-gray-200 font-medium">
                          Will QoS
                        </Label>
                        <Select
                          value={String(willQos)}
                          onValueChange={(val) => setWillQos(Number(val) as 0 | 1 | 2)}
                        >
                          <SelectTrigger className="mt-2 bg-gray-800/50 border-gray-700 hover:border-indigo-500 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/50 text-white rounded-lg">
                            <SelectValue />
                          </SelectTrigger>
                      ...
                      <div className="flex items-center group">
                        <Switch
                          id="willRetain"
                          checked={willRetain}
                          onCheckedChange={(checked) => setWillRetain(checked)}
                          className="data-[state=checked]:bg-indigo-500 data-[state=unchecked]:bg-gray-700 transition-colors duration-300"
                        />
                        <Label
                          htmlFor="willRetain"
                      ...
                      {protocolVersion === 5 && willTopic && (
                        <>
                          ...
                          <div className="group">
                            <Label htmlFor="willDelayInterval" className="text-gray-200 font-medium">
                          ...
                          <div className="group">
                            <Label htmlFor="willMessageExpiryInterval" className="text-gray-200 font-medium">
                          ...
                          <div className="group">
                            <Label htmlFor="willContentType" className="text-gray-200 font-medium">
                              Content Type
                            </Label>
                            <Input
                              id="willContentType"
                              ...
                              onChange={(e) => setWillContentType(e.target.value)}
                              className="mt-2 bg-gray-800/50 border-gray-700 hover:border-indigo-500 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/50 text-white rounded-lg"
                              placeholder="e.g., application/json"
                            />
                          </div>
                          <div className="group">
                            <Label htmlFor="willResponseTopic" className="text-gray-200 font-medium">
                              Response Topic
                            </Label>
                            <Input
                              ...
                              onChange={(e) => setWillResponseTopic(e.target.value)}
                              className="mt-2 bg-gray-800/50 border-gray-700 hover:border-indigo-500 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/50 text-white rounded-lg"
                              placeholder="e.g., /response/topic"
                            />
                          </div>
                          <div className="group">
                            <Label htmlFor="willCorrelationData" className="text-gray-200 font-medium">
                            ...
                            <Input
                              ...
                              onChange={(e) => setWillCorrelationData(e.target.value)}
                              className="mt-2 bg-gray-800/50 border-gray-700 hover:border-indigo-500 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/50 text-white rounded-lg"
                          ...
                          <div className="flex items-center group">
                            <Switch
                              ...
                              onCheckedChange={(checked) => setWillPayloadFormatIndicator(checked)}
                              className="data-[state=checked]:bg-indigo-500 data-[state=unchecked]:bg-gray-700 transition-colors duration-300"
                            />
                            <Label
                          ...
                          <div className="col-span-2 group">
                            <Label htmlFor="willUserProperties" className="text-gray-200 font-medium">
                              User Properties (JSON)
                            </Label>
                            <Textarea
                              id="willUserProperties"
                              value={willUserProperties}
                              onChange={(e) => setWillUserProperties(e.target.value)}
                              className="mt-2 bg-gray-800/50 border-gray-700 hover:border-indigo-500 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/50 text-white min-h-[100px] rounded-lg"
                              placeholder={`{\n  "key1": "value1",\n  "key2": "value2"\n}`}
                            />
                          </div>
            ...
            <div className="col-span-2 mt-6">
              <Accordion type="single" collapsible className="w-full">
                ...
                >
                  <AccordionTrigger className="px-4 py-3 hover:no-underline text-white text-lg font-semibold flex items-center bg-gray-800/50">
                    <FileLock size={20} className="mr-2 text-red-400 animate-pulse" />
                    ...
                    <div className="grid grid-cols-1 gap-y-6">
                      <div className="flex items-center group">
                        <Switch
                          ...
                          onCheckedChange={(checked) => setRejectUnauthorized(checked)}
                          className="data-[state=checked]:bg-indigo-500 data-[state=unchecked]:bg-gray-700 transition-colors duration-300"
                        />
                        <Label
                      ...
                      <div className="group">
                        <Label htmlFor="caCert" className="text-gray-200 font-medium">
                      ...
                      <div className="group">
                        <Label htmlFor="clientCert" className="text-gray-200 font-medium">
                      ...
                      <div className="group">
                        <Label htmlFor="clientKey" className="text-gray-200 font-medium">
                          Client Key (Base64)
                        </Label>
                        <Textarea
                          id="clientKey"
  ...
  <div className="mt-6 flex justify-end gap-4 border-t border-gray-800 pt-4">
    ...
    >
      <Save size={22} className="mr-2" /> {isNewConnection ? "Save New Connection" : "Update Connection"}
    </Button>
  </div>
</div>
  );
