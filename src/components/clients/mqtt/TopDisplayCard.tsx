// src/components/clients/mqtt/TopicDisplayCard.tsx
"use client";

import React from 'react';
import { SubscribeOptions } from '@/types/mqtt/mqtt';
  ...
  return (
    <div
      className={`relative p-4 rounded-lg shadow-md cursor-pointer transition-all duration-200
        ${isSelected ? 'bg-blue-600 border-blue-500 shadow-xl' : 'bg-gray-700 border-gray-600 hover:bg-gray-600'}
        border`}
    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          <MessageSquare size={20} className="mr-2" style={{ color: subscription.color }} />
          <h4 className="font-bold text-lg" style={{ color: subscription.color }}>
      ...
      <p className="text-gray-300 text-sm mt-1 truncate">Topic: {subscription.topic}</p>
