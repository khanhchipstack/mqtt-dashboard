...
const SubscribeSection: React.FC<SubscribeSectionProps> = ({
  ...
  return (
    <div className="px-3 py-3 bg-gray-900 rounded-2xl shadow-2xl flex flex-col h-full border-gray-800">
      {/* Header */}
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogTrigger asChild>
            <Button
              ...
              className="h-8 bg-green-600 hover:bg-green-700 text-white px-2 py-2 rounded-lg flex items-center shadow-md hover:shadow-green-500/20 transition"
            >
          ...
          <DialogContent className="max-w-md bg-gray-900 border border-gray-700 shadow-2xl rounded-2xl p-6">
            ...
            <form onSubmit={handleSubscribe} className="space-y-4">
              ...
              <div>
                ...
                <input
                  type="color"
                  className="w-full h-10 py-4 px-3 bg-gray-800 rounded-lg border border-gray-700 focus:ring-2 focus:ring-green-500"
                  value={color}
