...
const ConnectionForm: React.FC<ConnectionFormProps> = ({
  ...
  const [useSsl, setUseSsl] = useState(true); // Default to false
  ...
  useEffect(() => {
    if (connection) {
      ...
      setProtocol("wss");
      setUseSsl(true); // Ensure it's false for new connection
...
<div className="bg-gradient-to-br from-gray-900 to-gray-950 p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-800 backdrop-blur-lg bg-opacity-80 transition-all duration-300 hover:shadow-2xl">
                        ...
                        <>
                          <div className="group">
                            ...
                            <Input
                              ...
                              onChange={(e) => setSessionExpiryInterval(e.target.value === "" ? undefined : Number(e.target.value))}
                          ...
                          <div className="group">
                            ...
                            <Input
                              ...
                              onChange={(e) => setReceiveMaximum(e.target.value === "" ? undefined : Number(e.target.value))}
                              className="mt-1 sm:mt-2 bg-gray-800/50 border-gray-700 hover:border-indigo-500 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/50 text-white rounded-lg text-sm sm:text-base"
                              placeholder="Optional"
                              min={0}
                            />
                          ...
                          <div className="group">
                            ...
                            <Input
                              ...
                              onChange={(e) => setMaximumPacketSize(e.target.value === "" ? undefined : Number(e.target.value))}
                              className="mt-1 sm:mt-2 bg-gray-800/50 border-gray-700 hover:border-indigo-500 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/50 text-white rounded-lg text-sm sm:text-base"
                              placeholder="Optional"
                              min={0}
                            />
                          ...
                          <div className="group">
                            ...
                            <Input
                              ...
                              onChange={(e) => setTopicAliasMaximum(e.target.value === "" ? undefined : Number(e.target.value))}
                              className="mt-1 sm:mt-2 bg-gray-800/50 border-gray-700 hover:border-indigo-500 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/50 text-white rounded-lg text-sm sm:text-base"
                              placeholder="Optional"
                              min={0}
                            />
                        ...
                        <>
                          ...
                          <div className="group">
                            ...
                            <Input
                              ...
                              onChange={(e) => setWillDelayInterval(e.target.value === "" ? undefined : Number(e.target.value))}
                              className="mt-1 sm:mt-2 bg-gray-800/50 border-gray-700 hover:border-indigo-500 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/50 text-white rounded-lg text-sm sm:text-base"
                              placeholder="Optional"
                              min={0}
                            />
                          ...
                          <div className="group">
                            ...
                            <Input
                              ...
                              onChange={(e) => setWillMessageExpiryInterval(e.target.value === "" ? undefined : Number(e.target.value))}
                              className="mt-1 sm:mt-2 bg-gray-800/50 border-gray-700 hover:border-indigo-500 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/50 text-white rounded-lg text-sm sm:text-base"
                              placeholder="Optional"
                              min={0}
                            />
  ...
  <div className="mt-4 sm:mt-6 flex flex-col sm:flex-row justify-end gap-3 sm:gap-4 border-t border-gray-800 pt-3 sm:pt-4">
    ...
    <Button
      ...
      className="w-full sm:w-auto bg-gradient-to-r from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 text-white px-4 py-2 rounded-lg flex items-center transition-all duration-300 shadow-lg hover:shadow-green-500/30"
    >
      <Save size={18} className="mr-1 sm:mr-2 w-5 h-5 sm:w-6 sm:h-6" />{" "}
