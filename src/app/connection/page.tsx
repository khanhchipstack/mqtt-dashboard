      ...
      <div className="p-6">
        <div className="bg-gray-800 border border-gray-700 rounded-2xl shadow-lg p-8 space-y-8">
          ...
          <div className="flex flex-wrap gap-4">
            <Badge className="bg-green-600 px-4 py-1">MQTT 3.1.1 & 5.0</Badge>
            <Badge className="bg-blue-600 px-4 py-1">Realtime Monitoring</Badge>
            <Badge className="bg-yellow-500 px-4 py-1">
          ...
          <h2 className="text-2xl font-bold text-white flex items-center gap-2">
            <Server className="w-6 h-6" /> Thông Tin Kết Nối
          </h2>
          ...
          {/* Luồng Hoạt Động */}
          <h2 className="text-2xl font-bold text-white flex items-center gap-2">
            <Shuffle className="w-6 h-6" /> Luồng Hoạt Động Hệ Thống
          </h2>
          ...
          {/* Tính Năng Nổi Bật */}
          <h2 className="text-2xl font-bold text-white flex items-center gap-2">
            <BarChart2 className="w-6 h-6" /> Tính Năng Nổi Bật
          </h2>
          <ul className="list-disc list-inside text-gray-300 space-y-2">
          ...
          <h2 className="text-2xl font-bold text-white flex items-center gap-2">
            <Settings2 className="w-6 h-6" /> Thông Số Kỹ Thuật Chi Tiết
          </h2>
          <ul className="list-disc list-inside text-gray-300 space-y-2">
            <li>
              <strong>Name:</strong> Tên hiển thị cho kết nối{" "}
              <Badge className="bg-green-600 px-4 py-1">MQTT 3 & 5</Badge>
            </li>
            <li>
            ...
            <li>
              ...
              <Badge className="bg-indigo-500 rounded-md px-2 py-1 text-xs">MQTT 3</Badge>
            </li>
            <li>
            ...
            <li>
              ...
              <Badge className="bg-yellow-500 px-4 py-1">MQTT 5</Badge>
            </li>
            <li>
